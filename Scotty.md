---
title: "Haskell für Fortgeschrittene - 	Scotty"
...
[Scotty](https://github.com/scotty-web/scotty) ist ein einfaches
Web-Framework, dass gut mit mtl-style Transformern auskommt.

Im Prinzip müssen wir nur eine *Scotty-App* bauen, die einfache
Routen bestimmt:
...
und dann dafür *Actionen* schreiben:
...
für beides gibt es Monad-Transformatoren:
...
und `scottyT` übernimmt dann alles weitere:
...
falls man dass nicht braucht kann man auch einfach die Funktionen aus `Web.Scotty` verwenden.

---

# Quellcode
[siehe web/Main.hs](web/Main.hs)
